...
if (temperature >= 80 && rain === true) {
  ...
  console.log(`You should wear a t-shirt and shorts with some breezy footwear`);
} else if (temperature > 60 && temperature < 80 && rain === false) {
  console.log(`You should wear a t-shirt and shorts with some sneakers`);
} else if (temperature <= 60 && rain === false) {
  console.log(`You should wear some pants with a sweater, maybe accessorize with a scarf`);
}
